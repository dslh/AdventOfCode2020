...
def howManyAnswers(groupsAnswers): # This finds how many difference answers a group gave
    ...
    countLetters = {"a": 0, "b": 0, "c": 0, "d": 0, "e": 0, "f": 0, "g": 0, "h": 0, "i": 0, "j": 0, "k": 0, "l": 0, "m": 0, "n": 0, "o": 0, "p": 0, "q": 0, "r": 0, "s": 0, "t": 0, "u": 0, "v": 0, "w": 0, "x": 0, "y": 0, "z": 0} # Dictionary to count the # of letter occurances
    row = 0
    times = 0
    ...
    howMany = sum(valuesList) # Sums up the value of the countLetters dictionary, where they're either 0 or 1 #################Cycle dictionary to check how many have values >=1
    return howMany
